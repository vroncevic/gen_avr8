...
class OSCSelectorTestCase(unittest.TestCase):
    ...
    def test_choose_osc(self):
        ...
        self.osc_target = self.osc_select.choose_osc()
        print(type(self.osc_target))
        print(self.osc_target)
        self.assertEqual(type(self.osc_target), str)

    def test_check_osc(self):
        '''Test check selected OSC name.'''
        self.assertEqual(
            self.osc_target in self.osc_select.get_fosc_list(), True
        )
