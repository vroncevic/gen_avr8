...
try:
    from gen_avr8.avr8_pro.mcu_selector import MCUSelector
    from gen_avr8.avr8_pro.osc_selector import OSCSelector
    from gen_avr8.avr8_pro.read_template import ReadTemplate
    from gen_avr8.avr8_pro.write_template import WriteTemplate
