...
from gen_avr8.infrastructure.cli.setup.options import CLIBundleOptions
from gen_avr8.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_avr8.infrastructure.cli.setup.bundle import CLIBundle
from gen_avr8.infrastructure.cli.setup.keys import CLIBundleKeys
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenAVR8CommandDefinition()
        service_executor: ICommandExecutor = GenAVR8CommandExecutor(definition=service_definition)
